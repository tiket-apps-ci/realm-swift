...
static void ExpectMixedCollectionObjectChange(id self, MixedObject *obj, NSString *columnName, void (^block)(RLMRealm *)) {
    __block XCTestExpectation *expectation = nil;
...
- (void)testAddDictionaryToMixed {
    ...
    ExpectMixedCollectionObjectChange(self, _obj, @"anyCol", ^(RLMRealm *realm) {
...
- (void)testMixedDictionaryCollectionChanges {
    ...
    ExpectMixedDictionaryChange(self, @[@"key2"], @[@"key1", @"key3"], @[], ^(RLMRealm *realm) {
        MixedObject *mixedObject = [[MixedObject allObjects] firstObject];
...
- (void)testMixedArrayCollectionChanges {
    ...
    ExpectMixedArrayChange(self, @[@0], @[@0, @1], @[], ^(RLMRealm *realm) {
        MixedObject *mixedObject = [[MixedObject allObjects] firstObject];
        mixedObject.anyCol = @[ @YES, @987.321 ];
    });

    ExpectMixedArrayChange(self, @[], @[@2], @[], ^(RLMRealm *realm) {
        MixedObject *mixedObject = [[MixedObject allObjects] firstObject];
        RLMArray *array = (RLMArray *)mixedObject.anyCol;
        [array addObject: @NO];
    });
    ...
    ExpectMixedArrayChange(self, @[@0, @1, @2], @[], @[], ^(RLMRealm *realm) {
        MixedObject *mixedObject = [[MixedObject allObjects] firstObject];
        RLMArray *array = (RLMArray *)mixedObject.anyCol;
        [array removeAllObjects];
    });
